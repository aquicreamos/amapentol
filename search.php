<?php require_once('session.php'); require_once('conexion.php');?>
...
if ($cedula == $celula){
  	echo "<script>location.href='busqueda.php'</script>";
  } else {
...
<form action="search.php" method="POST" name="form1">
  <fieldset>
    <legend>Buscar Usuario <small>(Escriba el Numero de Cedula)</small></legend>
