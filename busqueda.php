                ...
                <div class="row">
                    ...
                    <!-- Apartir de este espacio se genera los contenidos -->
                        <h2>
                           ...
                           <h3>
                           Identificación: <small> <?php echo $ced; ?> </small></h3>
                        <ol class="breadcrumb">
                            <li class="active">
...
<!--Ingreso de Cedula-->
					<div class="form-group">
						...
						<div class="col-lg-10" >
						<input type="text" class="form-control" id="inputCedula" placeholder="<?php echo $idcedula;?>" name="ncedula" disabled>
...
<!--Ingreso de Nombre de Usuario-->
					<div class="form-group">
						...
						<div class="col-lg-10" >
						<input type="text" class="form-control" id="inputCedula" placeholder="<?php echo $Nicename; ?>" name="ncedula" disabled>
						<p class="form-control-static"></p></div>
					</div>
...
<!--Ingreso de contraseña-->
					<div class="form-group">
				      ...
				      <div class="col-lg-10">
					<input type="password" class="form-control" id="inputPassword" placeholder="<?php echo $contrasenia; ?>" name="npass1" disabled>
				      </div>
				    </div>
...
<!--Ingreso de Nombres-->
	      ...
	      <div class="col-lg-10">
	        <input type="text" class="form-control" id="inputNombres" placeholder="<?php echo $name; ?> " name="nnombre" disabled>
	      </div>
	    </div>
<!--Ingreso de Primer Apellido-->
	    <div class="form-group">
	      ...
	      <div class="col-lg-10">
	        <input type="text" class="form-control" id="inputApellido" placeholder="<?php echo $lastname1; ?>" name="napellido1" disabled>
	      </div>
	    </div>
<!--Ingreso de Apellido 2-->
	    <div class="form-group">
	      ...
	      <div class="col-lg-10">
	        <input type="text" class="form-control" id="inputApellido2" placeholder="<?php echo $lastname2; ?>" name="napellido2" disabled>
	      </div>
	    </div>
<!--Ingreso de Dirección-->
	    <div class="form-group">
	      ...
	      <div class="col-lg-10">
	        <input type="text" class="form-control" id="inputDireccion" placeholder="<?php echo $locality; ?>" name="ndireccion" disabled>
	      </div>
	    </div>
<!--Ingreso de Email Address-->
        ...
        <div class="col-lg-7"><div class="input-group">
		      <input class="form-control" type="email" placeholder="<?php echo $email; ?>" name="nemail" disabled>
		    </div></div>
		</div>
<!--Ingreso de Telefono-->
	     <div class="form-group">
	      ...
	      <div class="col-lg-10">
	        <input type="text" class="form-control" id="inputTel" placeholder="<?php echo $tel; ?>" name="nphone" disabled>
	      </div>
	    </div>
<!--Ingreso de Numero de Celular-->
	    <div class="form-group">
	      ...
	      <div class="col-lg-10">
	        <input type="text" class="form-control" id="inputCel" placeholder="<?php echo $cel; ?>" name="ncel" disabled>
	      </div>
	    </div>
	    ...
	    <div class="form-group">
	      ...
	      <div class="col-lg-10">
	        <input type="text" class="form-control" id="inputCel" placeholder="<?php echo $fage; ?> " name="ncel" disabled>
	      </div>
	    </div>
...
<!--Ingreso de Departamento-->
	    <?php $query = "SELECT departamentos.id_dep, departamentos.nombre_departamento FROM departamentos" or die("Error in the consult.." . mysqli_error($link)); $result = mysqli_query($link, $query); ?>
	      ...
	      <div class="col-lg-10">
	        <select class="form-control" id="inputDepartamento" name="ndepartamento" disabled>
...
<div class="form-group">
	      ...
	      <div class="col-lg-10">
	        <input type="text" class="form-control" id="inputMunicipio" placeholder="<?php echo $NombreMunicipio; ?>" name="nmunicipio" disabled>
	      </div>
	    </div>
...
<!--Ingreso de Banco-->
    <?php $querybk = "SELECT `bancos`.* FROM `bancos`" or die("Error in the consult.." . mysqli_error($link)); $resultbk = mysqli_query($link, $querybk); ?>
	      ...
	      <div class="col-lg-10">
	        <select class="form-control" id="inputBanco" name="nbanco" disabled>
...
<!--COMBO BOX SALUD-->
	    <?php $querysl = "SELECT `salud`.* FROM `salud` " or die("Error in the consult.." . mysqli_error($link)); $resultsl = mysqli_query($link, $querysl); ?>
	      ...
	      <div class="col-lg-10">
	        <select class="form-control" id="inputSalud" name="nsalud" disabled>
...
<!--COMBO BOX CLASE-->
	    <?php $querysl = "SELECT `clase`.* FROM `clase`" or die("Error in the consult.." . mysqli_error($link)); $resultsl = mysqli_query($link, $querysl); ?>
	      ...
	      <div class="col-lg-10">
	        <select class="form-control" id="inputClase" name="nclase" disabled>
...
<!--COMBO BOX CATEGORIA-->
	    <?php $querysl = "SELECT `categoriasuser`.* FROM `categoriasuser`" or die("Error in the consult.." . mysqli_error($link)); $resultsl = mysqli_query($link, $querysl); ?>
	      ...
	      <div class="col-lg-10">
	        <select class="form-control" id="inputTipo" name="ntipo" disabled>
...
<!--COMBO BOX CATEGORIA-->
	    <?php $querysl = "SELECT `activo`.* FROM `activo`" or die("Error in the consult.." . mysqli_error($link)); $resultsl = mysqli_query($link, $querysl); ?>
	      ...
	      <div class="col-lg-10">
	        <select class="form-control" id="inputActivo" name="nactivo" disabled>
	    ...
	    <!--<div class="form-group">
	      <div class="col-lg-10 col-lg-offset-2">
	        ...
	        <button type="submit" onClick="comprobarClave()" class="btn btn-primary">Editar</button>
	      </div>
	    </div>-->
														</div>
													</div>
