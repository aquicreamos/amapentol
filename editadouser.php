...
<?php
 ...
 $er_ideditar3 = $_SESSION['editaruser']; 
// echo $er_ideditar3;
/*Infomación USUARIO*/
...
while($er_row = mysqli_fetch_array($er_result , MYSQLI_ASSOC)) { 
  ...
  if ($er_ideditar3 != $er_usert) {
   ...
   $er_upquery = "UPDATE `amapentol`.`afiliados` SET `Apellido` = '$er_apellido1', `segApellido` = '$er_apellido2', `FNacimiento` = '$er_nacimiento', `Nombre` = '$er_nombre', `Direccion` = '$er_direccion', `Telefonofijo` = '$er_phone', `TelCelular` = '$er_cel', `email` = '$er_email', `departamentos_id` = '$er_departamento', `Municipio` = '$er_municipio', `nicename` = '$er_ideditar3', `contrasenia` = '$er_pass' WHERE `afiliados`.`idCedula` = '$er_ideditar3';";
    $val = mysqli_query($link, $er_upquery);


    $er_upcaquery =  "UPDATE `amapentol`.`afiliados` SET `departamentos_id` = '$er_departamento', `contrasenia` = '$er_pass' WHERE `afiliados`.`idCedula` = '$er_ideditar3';";  mysqli_query($link, $er_upcaquery);

   $er_up2query = "UPDATE `amapentol`.`afiliados` SET `Bancos_idBancos` = '$er_banco', `Salud_idSalud` = '$er_salud', `Clase_idClase` = '$er_clase' WHERE `afiliados`.`idCedula` = '$er_ideditar3';"; mysqli_query($link, $er_up2query);
