...
$er_ideditar2 = $_GET['value'];
$_SESSION['editarreporte'] = $er_ideditar2;
...
/*Datos Usuario*/
  ...
  $er_idCategoriauser = $er_row["idCategoriasuser"];
  $er_idSalud = $er_row["idSalud"];
  $er_idActivo = $er_row["idactivo"];
...
<div class="container">
 <!-- Page Heading -->
                <div class="row">
                    <div class="col-lg-12">
      <form class="form-horizontal" action="editadoreporte.php" method="POST" name="form2">
		<fieldset>
...
<!--Inicio del Formulario-->
	...
	<legend>Datos Principales de Contacto</legend>
		<div class="form-group">
						...
						<div class="col-lg-10">
						<input type="text" class="form-control" id="inputCedula" placeholder="Usuario/Cedula" name="er_cedula" value="<?php echo $er_idcedula; ?>">
						</div>
					</div>
...
<!--Ingreso de Usurio-->
					<div class="form-group">
						...
						<div class="col-lg-10">
						<input type="text" class="form-control" id="inputUser" placeholder="Usuario/Cedula" name="er_user" value="<?php echo $er_Nicename; ?>" >
						</div>
					</div>
